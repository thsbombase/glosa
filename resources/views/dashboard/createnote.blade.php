...
<section class="m-8 ">
    <div class="flex mb-3" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 ">Create Note</span>
            </div>
            </li>
        </ol>
    </div>
    ...
    <div class="p-6 max-w-full bg-white rounded-lg border border-gray-200 shadow-md grid grid-cols-1 gap-4">
        ...
        <div class="ring-2 ring-gray-300 rounded">
            <div id="editorjs"></div>
        </div>
        <button type="button" class=" px-4 py-3 text-lg md:px-8 md:py-3 md:mr-2 md:text-xl font-medium text-center text-white bg-teal-600 rounded-lg cursor-pointer hover:bg-teal-700 focus:ring-teal-800" id="save">Save</button>
    </div>
</section>
